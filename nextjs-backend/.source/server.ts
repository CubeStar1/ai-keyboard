...
export const docs = await create.docs(
  ...
  'src/content/docs',
  {
    ...
    'features/meta.json': __fd_glob_1,
    'getting-started/meta.json': __fd_glob_2,
  },
  {
    'architecture.mdx': __fd_glob_3,
    'index.mdx': __fd_glob_4,
    'shortcuts.mdx': __fd_glob_5,
    'features/action-menu.mdx': __fd_glob_6,
    'features/brain-memory.mdx': __fd_glob_7,
    'features/interview-copilot.mdx': __fd_glob_8,
    'features/suggestions.mdx': __fd_glob_9,
    'getting-started/installation.mdx': __fd_glob_10,
  }
)
